 ...
 * Inserts <hr> section breaks (and Section Metadata blocks for styled sections)
 * from payload.template.sections. Selectors come from page-templates.json,
 ...
 * exists) using a marker attribute, then Section Metadata is anchored to the
 * marker in afterTransform — because block parsers run between the hooks and
 * replace section elements (see generate-import-transformer.md).
 *
 * home template: 5 sections, all style:null → expect 4 <hr>, 0 Section Metadata.
 */
